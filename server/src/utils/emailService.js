...
const sendOTPEmail = async (email, otp, userName) => {
  ...
  return sendEmail(
    email,
    'UTM Engage - Email Verification Code',
    html,
...
const sendPasswordResetEmail = async (email, otp, userName) => {
  ...
  return sendEmail(
    email,
    'UTM Engage - Password Reset Code',
    html,
...
const sendCommitteeRejectionEmail = async (email, userName, committeeName) => {
        ...
        <div style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background-color: #f1f5f9; border-radius: 12px; padding: 24px; text-align: center; margin: 24px 0;">
              ...
              <div style="font-size: 22px; font-weight: bold; color: #005eb8;">${committeeName}</div>
            </div>
            <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 16px 0;">
              If you believe this was a mistake or would like more information, please contact the platform administrator.
            </p>
          </div>
          <div style="background-color: #f8fafc; padding: 20px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">&copy; 2025 UTM Engagement Platform. All rights reserved.</p>
          </div>
        </div>
      </div>
    </body>
  ...
  return sendEmail(
    email,
    'UTM Engage - Committee Application Rejected',
    html,
...
const sendCommitteeInvitationEmail = async (email, inviterName, committeeName, acceptUrl, declineUrl) => {
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        <div style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <p style="color: #ef4444; font-size: 13px; margin: 16px 0; font-weight: 500;">This invitation will expire in 7 days.</p>
          </div>
          <div style="background-color: #f8fafc; padding: 20px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">&copy; 2025 UTM Engagement Platform. All rights reserved.</p>
          </div>
  ...
  return sendEmail(
    email,
    'UTM Engage - Committee Invitation',
    html,
        ...
        <div style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background-color: #f1f5f9; border-radius: 12px; padding: 24px; margin: 24px 0; border-left: 4px solid #16a34a;">
              ...
              <div style="font-size: 22px; font-weight: bold; color: #005eb8;">${eventTitle}</div>
            </div>
          </div>
          <div style="background-color: #f8fafc; padding: 20px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">&copy; 2025 UTM Engagement Platform. All rights reserved.</p>
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        <div style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 16px 0;">
              If you believe this was in error, please contact the administration. You may also modify and resubmit your event.
            </p>
          </div>
          <div style="background-color: #f8fafc; padding: 20px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
            <p style="color: #94a3b8; font-size: 12px; margin: 0;">&copy; 2025 UTM Engagement Platform. All rights reserved.</p>
...
const sendMeetingScheduledEmail = async (email, userName, meetingDetails) => {
        ...
        <div style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); overflow: hidden;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background-color: #f1f5f9; border-radius: 12px; padding: 20px; margin: 24px 0; border-left: 4px solid ${typeColor};">
              <div style="font-size: 20px; font-weight: bold; color: #1e293b; margin-bottom: 12px;">${title}</div>
              ...
              <table style="width: 100%; border-collapse: collapse; margin-top: 8px;">
                <tr><td style="padding:8px 12px;color:#64748b;font-size:14px;border-bottom:1px solid #e2e8f0;width:120px;"><strong>Date</strong></td><td style="padding:8px 12px;color:#1e293b;font-size:14px;border-bottom:1px solid #e2e8f0;">${formattedDate}</td></tr>
                <tr><td style="padding:8px 12px;color:#64748b;font-size:14px;border-bottom:1px solid #e2e8f0;width:120px;"><strong>Time</strong></td><td style="padding:8px 12px;color:#1e293b;font-size:14px;border-bottom:1px solid #e2e8f0;">${timeRange}</td></tr>
                ${locationRow}
                ${meetingLinkRow}
                ${descriptionRow}
              </table>
  ...
  return sendEmail(
    email,
    `UTM Engage - Meeting Scheduled: ${title}`,
    html,
